    ...
    <header>
      ...
      <nav>
        <ul className={toggle ? 'toggle' : ''}>
          <li>
            <NavLink onClick={menuToggleBtn} to="/home">
              Home
            </NavLink>
          </li>
          <li>
            <NavLink onClick={menuToggleBtn} to="/product">
              Product
            </NavLink>
          </li>
          <li>
            <NavLink onClick={menuToggleBtn} to="/contact">
              Contact
            </NavLink>
          </li>
          <li>
            <NavLink onClick={menuToggleBtn} to="/about">
              About
            </NavLink>
          </li>
          <li>
            <NavLink onClick={menuToggleBtn} to="/login">
              Login / Register
            </NavLink>
          </li>
          <li className="close" onClick={menuToggleBtn}>
            <img src={Close} alt="close icon" width="20" />
          </li>
        </ul>
